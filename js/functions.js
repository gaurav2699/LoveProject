...
$(function () {
	...
	// Get actual computed dimensions after CSS is applied
	...
	var offsetY = canvasHeight / 2 - 55;
	
	// Adjust offset for mobile
	if (window.innerWidth <= 480) {
		offsetY = canvasHeight / 2 - 5;
	} else if (window.innerWidth <= 768) {
		offsetY = canvasHeight / 2 - 8;
	}
	...
	// Only set content dimensions on desktop
